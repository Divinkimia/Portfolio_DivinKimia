// Animations JavaScript pour la page CS SNO - Thème vert/violet Jean Zay
...
(function() {
    ...
    function createCodeParticles() {
        ...
        const codeSymbols = ['<', '>', '{', '}', '(', ')', '[', ']', '/', '*', '=', '+', '-', ';', ':', '&', '|', '!', '?', '%', '$', '#', '@'];
        const colors = ['#6DBF4B', '#8BC34A', '#9CCC65', '#AED581'];
            ...
            nodes.forEach((node, i) => {
                nodes.slice(i + 1).forEach(otherNode => {
                    ...
                    if (distance < 150) {
                        ...
                        ctx.strokeStyle = `rgba(109, 191, 75, ${1 - distance / 150})`;
                        ctx.lineWidth = 1;
                        ctx.stroke();
                    }
                });
    ...
    function createDataFlow() {
        ...
        function createDataPacket() {
            ...
            packet.style.cssText = `
                ...
                background: #2E7D32;
                border-radius: 50%;
                box-shadow: 0 0 ${size * 2}px #6DBF4B;
        ...
        cards.forEach(card => {
            card.addEventListener('mouseenter', function() {
                ...
                dataEffect.style.cssText = `
                    ...
                    width: 100%;
                    height: 100%;
                    background: radial-gradient(circle, rgba(109, 191, 75, 0.2) 0%, transparent 70%);
