// Animations JavaScript pour la page BTS SIO - Thème informatique
...
(function() {
    ...
    function createCodeParticles() {
        ...
        const codeSymbols = ['<', '>', '{', '}', '(', ')', '[', ']', '/', '*', '=', '+', '-', ';', ':', '&', '|', '!', '?', '%', '$', '#', '@'];
        const colors = ['#ff9900', '#ffaa33', '#ffbb55', '#ffcc77'];
            ...
            nodes.forEach((node, i) => {
                nodes.slice(i + 1).forEach(otherNode => {
                    ...
                    if (distance < 150) {
                        ...
                        ctx.strokeStyle = `rgba(255, 153, 0, ${1 - distance / 150})`;
                        ctx.lineWidth = 1;
                        ctx.stroke();
                    }
                });
    ...
    function createDataFlow() {
        ...
        function createDataPacket() {
            ...
            packet.style.cssText = `
                ...
                background: #ff9900;
                border-radius: 50%;
                box-shadow: 0 0 ${size * 2}px #ff9900;
        ...
        rows.forEach((row, index) => {
            row.addEventListener('mouseenter', function() {
                ...
                cells.forEach(cell => {
                    ...
                    cell.style.backgroundColor = 'rgba(255, 153, 0, 0.1)';
