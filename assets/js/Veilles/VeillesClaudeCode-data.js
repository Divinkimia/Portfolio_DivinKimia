      ...
      lessons: [
        {
          ...
          body: [
            ...
            'Aujourd’hui, cet écosystème est toujours actif et continue d’évoluer, avec des mises à jour régulières, de nouvelles capacités et une intégration de plus en plus poussée dans les usages professionnels.'
          ],
          bullets: [
            'Temporalité : essor des LLM puis spécialisation (travail, IDE).',
            'Méthode : documentation produit, changelog, revalidation avant oral.',
            'Ne pas figer une capacité sans date de référence.'
          ]
        }
      ]
    },
      ...
      lessons: [
        {
          ...
          body: [
            ...
            'Pour mener une veille, on croise la documentation officielle, les annonces de fonctionnalités, les démonstrations vidéo, les retours sur les réseaux sociaux et les articles spécialisés — ce qui permet de suivre à la fois l’évolution technique et les usages concrets.'
          ],
          bullets: [
            'Chaîne de valeur : besoin → contexte (chat / travail / repo) → livrable.',
            'Veille : sources multiples (officiel, communauté, presse spécialisée).',
            'Comparer les environnements aide à cadrer un usage responsable.'
          ],
          appendHtml: `
<div class="veille-lesson-rich">
  <p class="veille-code-hint mb-1">Trois environnements complémentaires</p>
  <div class="veille-heygen-table-wrap"><table class="veille-heygen-table"><thead><tr><th>Environnement</th><th>Rôle principal</th><th>Usage typique</th></tr></thead><tbody>
    <tr><td><strong>Claude</strong></td><td>Assistant général, documents, dialogue</td><td>Questions, rédaction, analyse de texte</td></tr>
    <tr><td><strong>Claude Work</strong> / espaces pro</td><td>Organisation, contexte projet, collaboration</td><td>Équipes, livrables, capitalisation</td></tr>
    <tr><td><strong>Claude Code</strong></td><td>Développement assisté (IDE / terminal)</td><td>Lecture de code, correctifs, refactor, debug</td></tr>
  </tbody></table></div>
  <p class="veille-code-hint mt-4 mb-1">Veille réalisée avec (exemples de sources)</p>
  <ul class="veille-objectives-list">
    <li>Documentation et annonces officielles Anthropic / Claude.</li>
    <li>Démonstrations vidéo et prises en main communautaires.</li>
    <li>Retours d’utilisateurs (réseaux sociaux, forums, blogs tech).</li>
    <li>Articles spécialisés en IA et en développement logiciel.</li>
  </ul>
</div>`
        }
      ]
      ...
      lessons: [
        {
          ...
          bullets: [
            ...
            'Trois registres : rédaction, organisation, code.',
            'Critère de réussite : argumenter avec exemples et sources à jour.'
          ]
        }
      ]
    },
      ...
      lessons: [
        {
          ...
          bullets: [
            ...
            'Claude Code : accélération sous réserve de revue et de tests.',
            'Vision métier : l’outil change les habitudes, pas la responsabilité.'
          ]
        }
      ]
    },
      ...
      lessons: [
        {
          ...
          bullets: [
            'Synthèse : IA comme ensemble d’outils contextualisés.',
            'Poursuite : suivre les releases produit et les cadres légaux / éthiques.',
            'Ressources : panneau latéral « Ressources » pour les références officielles.'
          ]
        }
      ]
    }
