/**
 * Veille HeyGen — même parcours que OpenClaw (sidebar, accordéon, leçons)
 * Données : window.VEILLE_DATA (VeillesHeyGen-data.js)
 */
(function () {
  'use strict';
  ...
  function selectLesson(index) {
    ...
    document.title = 'Divin Kimia | ' + L.title + ' — HeyGen';
